  ...
  return (
    <div className="bg-white rounded-2xl shadow flex flex-col px-6 py-4 w-full">
      ...
      <div className="flex flex-col mb-4">
        <div className="flex justify-between">
          <span className="font-normal text-gray-400 mb-2">Subtotal</span>
          <span className="text-gray-400">10₺</span>
        </div>
        <div className="flex justify-between">
          <span className="font-normal text-gray-400 mb-2">Shipping</span>
          <span className="text-gray-400">10₺</span>
        </div>
        <div className="flex justify-between">
          <span className="font-normal text-gray-400 mb-2">Taxes</span>
          <span className="text-gray-400">10₺</span>
        </div>
      </div>
